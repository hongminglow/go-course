...
func (p *password) Set(plaintextPassword string) error {
	// * Longer character passwords are more secure
	// * However, it takes more computational power to hash them
	// * bcrypt will automatically generate a salt and include it in the hash
