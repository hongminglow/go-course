...
// * Test file in Go usually ends with _test.go
// * Use "require" and "assert" from testify package for assertions
// * Separated database is used for testing to avoid messing with production data
